...
import ListCardUser from "../../assets/components/ListCardUser";
import DynamicInputs from "../../assets/components/DynamicInputs";
        ...
        {showProfileData == "op" ? (
          ...
          <DataCompany>
            <TextHeader>
              ...
              nulla dolores ut facilis numquam, adipisci eveniet illum hic
              eligendi. Sequi!
            </TextHeader>
            <Line />
            <DataCompany>
          ...
          <Time>
            <ListCardUser companyId={company.id} />
...
Company.getLayout = function getLayout(page: ReactNode) {
  return <MainLayout color="">{page}</MainLayout>;
};
